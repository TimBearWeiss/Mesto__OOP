...
// кнопочки 
export const buttonSaveAvatar = popupAvatar.querySelector('.popup__save');
export const buttonSaveProfile = popupProfile.querySelector('.popup__save');
export const buttonSaveAddCard = popupAddCard.querySelector('.popup__save');
...
export const avatarInput = document.querySelector('#avatarId'); 
